...
public class AllocatorRegistry
{
	...
	public void add(IInventoryProvider p) {list.add(p);}
	public void add(IInventoryProviderEntity p) {list2.add(p);}
	 ...
	 * @param entities (modifyable list)
	 * @param isInput - is this input?
