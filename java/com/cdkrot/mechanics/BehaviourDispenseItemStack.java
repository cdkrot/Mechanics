...
public class BehaviourDispenseItemStack extends BehaviorDefaultDispenseItem {
    @Override
    protected ItemStack dispenseStack(IBlockSource blockSource,
            ItemStack itemStack) {
        EnumFacing facing = EnumFacing
                .getFront(blockSource.getBlockMetadata() % 6);
        IPosition position = BlockDispenser.func_149939_a(blockSource);// temporary
                                                                       // solution
